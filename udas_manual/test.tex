...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=9cm]{fig_idl71/Fig1.eps}
...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=9cm]{fig_idl71/Fig7.eps}
%\caption{Preferences (Windows, IDL71)}
...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=9cm]{fig_idl64/Fig1.eps}
...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=9cm]{fig_idl64/Fig4.eps}
%\caption{Preferences (Windows, IDL64)}
...
%\begin{figure}[H]
%\begin{center}
%\includegraphics[width=9cm]{fig_idl64/Fig7.eps}
%\caption{IDL Workbench (Windows, IDL64)}
